...
/                   Fixed a wrong directory entry is created on non-LFN cfg
 * when the given name contains ';'.
 ...
 *
 *
 * March 2012. Modified by Kevin Krieger for EP495, BLADE instrument.
...
/* Test data */
const char microSDTestData[1024] = "This text was written to this file using"\
"the CAN-obd2 v1 board, designed by Kevin Krieger April 2014.";
const TCHAR *testfilename = "test.txt";
const char microRestartedMsg[64] = "Micro Restarted\r\n";

/* Other data, such as filesystems and file objects used */
FATFS Fatfs[_VOLUMES];		/* File system object for each logical drive */
FIL File[2];				/* File objects */
char sdbuffer[1024] __attribute__ ((aligned (4))) ;	/* Working buffer, this will
overflow your bss segment if it is too large. */
...
)
{
	...
	*rfs = fs = FatFs[vol];				/* Return pointer to the corresponding file system object */
	...
	if (stat & STA_NOINIT)				/* Check if the initialization succeeded */
		return FR_NOT_READY;			/* Failed to initialize due to no media or hard error  THIS IS HAPPENING!*/
